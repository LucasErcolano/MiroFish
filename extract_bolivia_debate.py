...
conn = sqlite3.connect('backtesting/s3-cross-topic-injection/multiagent_bolivia/reddit_simulation.db')
c = conn.cursor()
...
with open('bolivia_debate_analysis.md', 'w', encoding='utf-8') as f:
    f.write("# S3 Bolivia Multi-Agent Debate Analysis\n\n")
    f.write("This document tracks the interaction between the agents in the S3 Bolivia simulation after the counter-signal was injected.\n\n")
...
print("Debate analysis written to bolivia_debate_analysis.md")
