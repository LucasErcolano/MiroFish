#!/usr/bin/env python3
"""Run the IPC temporal matrix against a live MiroFish backend."""
...
def run_variant(base_url: str, config: Dict[str, Any], variant_id: str, force: bool) -> Path:
    ...
    project_metadata = {
        ...
        "task_objective": "Predict Argentina IPC 2025 under the allowed pre-cutoff evidence.",
    ...
    report_response = json_request(
        ...
        "/api/report/generate",
        {
            ...
            "schema_id": config["fixed_simulation_config"].get("schema_id", "arg_ipc_2025_v1"),
            "report_context": {
                "case_id": experiment["case_id"],
                "temporal_package": package["id"],
                "cutoff_date": package["max_document_date"],
