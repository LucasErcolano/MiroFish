...
Armar el caso IPC en formato `backtesting/`, como el caso Bolivia, para correr pruebas Gemma con distintas profundidades de simulacion.

La pregunta no es quien gana una eleccion, sino si MiroFish puede predecir la trayectoria del IPC argentino 2025 usando solo evidencia disponible hasta el `2025-01-31`.
...
Este directorio todavia no contiene corridas nuevas. El siguiente paso es ejecutar Gemma con las variantes de `testing_protocol.md` y guardar cada resultado en `output/<variant>/`.
