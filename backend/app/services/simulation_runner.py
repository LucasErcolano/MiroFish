...
class SimulationRunner:
    ...
    def start_simulation(
        ...
        try:
            ...
            # The interactive OASIS subprocess may use a different provider
            # from graph/report/profile generation. These optional overrides
            # keep that separation without mutating the parent process env.
