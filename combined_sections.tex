...
Una vez establecidos los casos de estudio, la infraestructura de ingestión de datos y la arquitectura base de MiroFish, resultó metodológicamente imperativo establecer un \textit{benchmark} riguroso utilizando modelos de lenguaje en aislamiento (paradigma \textit{Single-Agent} / \textit{Single-Model}). 
...
\subsubsection{Prueba 2: Continuación de Inyección Dinámica (Variación de Momento)}
...
\subsubsection{Prueba 3: Continuación de Inyección de Ruido (Shock de Entropía Tardío)}
...
\subsubsection{Prueba 4: Actualización Temporal de la Evidencia}

En el \textit{baseline}, las ventanas temporales T0--T3 no produjeron un patrón único: en IPC, la incorporación acumulativa de información redujo el error; en Bolivia, la evidencia tardía revirtió el acierto de T1; y en Copa América mantuvo al mismo ganador mientras ajustaba la incertidumbre. Por lo tanto, la recencia no funciona como una garantía de mejora independiente del tipo de evidencia.

Para dar continuidad a esta línea en la red Multi-Agente, reemplazamos el \textit{cutoff} estático por flujos de datos iterativos que simulan el paso del tiempo. El objetivo es observar cómo una red heterogénea incorpora actualizaciones y contrapesos sin atribuir de antemano cualquier cambio a la mera cercanía temporal. La diversidad arquitectónica puede amortiguar una extrapolación rígida, pero requiere que el flujo de evidencia se sostenga y que su procedencia sea controlada.
